...
const FEATURES = [
  {
    icon: "🌾",
    title: "Farm to Pouch",
    desc: "Sourced directly from Mithila's sacred ponds — zero middlemen, zero compromise.",
  },
  {
    icon: "🔥",
    title: "Slow Roasted",
  ...
  },
  {
    icon: "📦",
    title: "Fast Delivery",
    desc: "Pan-India shipping in 2–4 days with real-time order tracking on your phone.",
  },
];
...
const TESTIMONIALS = [
  {
    text: "Honestly the best makhana I've ever had. The peri peri flavour is completely addictive — I've already ordered three times!",
    author: "Priya S.",
    city: "Mumbai",
    rating: 5,
  },
  {
    text: "My whole family switched from chips to Valmiki Foods. Fresh, crunchy, and ships super fast. Highly recommended.",
    author: "Rahul M.",
    city: "Delhi",
    rating: 5,
  },
  {
    text: "Ordered the classic salt and herb turmeric — both are phenomenal. Love that they're actually clean ingredients.",
    author: "Ananya K.",
    city: "Bangalore",
    rating: 4,
  },
    ...
    <div style={{ background: "var(--warm-white)" }}>
      ...
      >
        ...
        {products.filter(
          ...
          <div style={{ textAlign: "center", marginTop: "2.5rem" }}>
            <Link to="/shop" className="btn btn-outline">
              View All Dry Fruits <ArrowRight size={15} />
            </Link>
          </div>
        )}
      </section>
